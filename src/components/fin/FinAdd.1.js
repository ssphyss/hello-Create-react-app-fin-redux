        ...
        return(
            <div style={{ margin: '50px 20px', padding: '30px', backgroundColor: '#ffffff'}} >
                ...
                <InputGroup size="large" compact>
                    {/* 日期 */}
                    <DatePicker 
                        // value={this.props.data[0].date}
                        // defaultValue={this.props.data[0].date}
                    ...
                    {/* 類別 */}
                    <Select 
                        defaultValue="收入/支出" size="large" style={{ width: '120px' }} >
                    ...
                    {/* 類別2 */}
                    <Select 
                        defaultValue="請選擇" size="large" style={{ width: 150 }}>
